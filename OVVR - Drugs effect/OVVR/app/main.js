 ...
 *------------------------------------------------------------------------
 */
    env.gui_3.pcmkr  = env.gui_3.addFolder( "Natural_Pace_Maker") ;
...
function Environment(){
    ...
    this.ENDO        = 1 ;
    this.MID         = 2 ;
    this.cellType    =  this.EPI ;
    this.epiEndoMid  =  'Epicardium';
    this.SGNalate    =  1.0 ;
    this.SGto        =  4.0 ;
    this.SPCa        =  2.5 ;
    this.SGKr        =  0.8 ;
    ...
    this.paceMakerActive    = true ;
    this.paceMakerPeriod    = 450 ;
    this.paceMakerPositionX = 0.0 ;
    this.paceMakerPositionY = 0.0 ;
...
function loadWebGL()
{
// define the env variable and add it to both window and document ........
    env = new Environment() ;
    window.env = env;  
    document.env = env ;
...
/*------------------------------------------------------------------------
 * sample voltage along the diagonal  
 *------------------------------------------------------------------------
 */
    env.sampler = new (class Sampler{
        constructor(){
            var MAX_SAMPLE_ARRAY = 1000 ;
            this.size = 10 ;
            this.texture = new Abubu.Float32Texture(this.size, 1, 
                { pairable : true  }  ) ;
            this.solver = new Abubu.Solver({
                fragmentShader : sampleShader ,
                uniforms : {
                    in_colr : { type :'s', value : env.fvvxc ,
                    minFilter : 'linear' , magFilter : 'linear' } ,
                } ,
                targets: {
                    out_colr : { location : 0 , target : this.texture }
                }
            } ) ;

            this.samples = [] ;
            for(var i =0 ; i< MAX_SAMPLE_ARRAY ; i++){
                this.samples.push("") ;
            }
            this.samples[0] =  "data:text;charset=utf-8," ;
        }
        ...
        save(filename){
            ...
            var tsvEncoded = encodeURI( this.samples ) ;
        ...
        record(){
            var k = Math.floor( env.time / 500 ) ;
            this.solver.render() ;
            var value = this.value ;
            this.samples[k] += Math.round(env.time) ;
            for(var i= 0 ; i< this.size ; i++ ){
                this.samples[k] += "\t"+value[i*4.].toFixed(3) ;
            }
            this.samples[k] += "\n"
        }
    } )() ;
...
// canvas recorder .......................................................
    env.canvasRecorder = new CanvasStreamRecorder( env.canvas_1 ) ; 
 ...
 */
    ...
    env._setNo = 0 ;
    Object.defineProperty(env, 'setNo' , {
        get : function(){
            return env._setNo ;
        } , 
        set : function(nv){
    ...
    Object.defineProperty( env, 'setName' , {
        get : function(){
            return this.sets[this.setNo] ;
        } ,
        set : function(nv){
            for(let i=0; i < env.sets.length; i++){
                let name = env.sets[i] ;
                if (name == nv){
                    env.setNo = i ;
                    console.log(env.setNo) ;
                    break ;
                }
            }
        }
        ...
        if (env.scripting){
            switch (env.setNo){
                case 0 : /* control */
                    ...
                    break ;
                case 1 : /* HCQ Only - low */
                    console.log('HCQ - Only - LOW') ;
                    env.C_Na    = 1. - 0.25 + 0.04 ;
                    env.C_CaL   = 1. - 0.09 + 0.03 ;
                    env.C_Kr    = 1. - 0.65 + 0.07 ;
                    env.C_Ks    = 1. - 0.07 + 0.07 ;
                    env.C_K1    = 1. - 0.86 + 0.07 ;
                    env.C_to    =1.0;
                    env.C_NaCa  =1.0;
                    env.C_NaK   =1.0;
                    env.C_pCa   =1.0;
                ...
                case 2 : /* HCQ Only - mid */
                    ...
                    env.threshold = -60. ;
                    break ;
                case 3 : /* HCQ Only - high */
                    console.log('HCQ - Only - HIGH') ;
                    env.C_Na    = 1. - 0.25 - 0.04 ;
                    env.C_CaL   = 1. - 0.09 - 0.03 ;
                    env.C_Kr    = 1. - 0.65 - 0.07 ;
                    env.C_Ks    = 1. - 0.07 - 0.07 ;
                    ...
                    break ;
                case 4 : /* AZT Only - low */
                    env.C_Na    = 1. - 0.15 + 0.03 ;
                    env.C_CaL   = 1. - 0.07 + 0.05 ;
                    env.C_Kr    = 1. - 0.20 + 0.03 ;
                    env.C_Ks    = 1. - 0.06 + 0.03 ;
                    env.C_K1    = 1. - 0.04 + 0.02 ;
                    env.C_to    =1.0;
                    env.C_NaCa  =1.0;
                    env.C_NaK   =1.0;
                    env.C_pCa   =1.0;
                ...
                case 6 : /* AZT Only - High */
                    ...
                    break ;
                case 7 : /* COMBO - LOW*/
                    console.log('COMBO - LOW') ;
                    env.C_Na    = 1. - 0.25 + 0.04 + 0.02 ;
                    env.C_CaL   = 1. - 0.09 + 0.03 + 0.04 ;
                    env.C_Kr    = 1. - 0.65 + 0.07 + 0.00 ;
                    env.C_Ks    = 1. - 0.07 + 0.07 - 0.02 ;
                    env.C_K1    = 1. - 0.86 + 0.07 - 0.02 ;
                    env.C_to    =1.0;
                    env.C_NaCa  =1.0;
                    env.C_NaK   =1.0;
                    env.C_pCa   =1.0;
                    ...
                    break ;
                case 8 : /* COMBO - MID */
                    console.log('COMBO - MID') ;
                    env.C_Na    = 1. - 0.25  + 0.02 ;
                    env.C_CaL   = 1. - 0.09  + 0.04 ;
                    env.C_Kr    = 1. - 0.65  + 0.00 ;
                    env.C_Ks    = 1. - 0.07  - 0.02 ;
                    env.C_K1    = 1. - 0.86  - 0.02 ;
                    env.C_to    =1.0;
                    env.C_NaCa  =1.0;
                    env.C_NaK   =1.0;
                    env.C_pCa   =1.0;
                ...
                case 11 : /* SOTALOL - MID */
                    ...
                    env.threshold = -60. ;
                    break ;
                case 12 : /* SOTALOL - HIGH */
                    console.log('SOTALOL - HIGH') ;
                    env.C_Kr    = 0.27686;
                    env.C_CaL   = 0.93467;
                    env.C_Na    = 0.98237;
                    env.C_to    = 0.96566;
                    ...
                    env.threshold = -60. ;
                    break ;
                case 13 : /* Ondansetron - LOW */
                    console.log('Ondansetron - LOW') ;
                    env.C_Kr    = 0.88348;
                    env.C_CaL   = 0.98323;
                    env.C_Na    = 0.99760;
                    env.C_to    = 0.9986;
                    ...
                    env.threshold = -60. ;
                    break ;
                case 14 : /* Ondansetron - MID */
                    console.log('Ondansetron - MID') ;
                    env.C_Kr    = 0.48838;
                    env.C_CaL   = 0.90284;
                    env.C_Na    = 0.97646;
                    env.C_to    = 0.99864;
                    ...
                    env.threshold = -60. ;
                    break ;
                case 15 : /* Ondansetron - HIGH */
                    console.log('Ondansetron - HIGH') ;
                    env.C_Kr    = 0.29501;
                    env.C_CaL   = 0.817;
                    env.C_Na    = 0.94316;
                    env.C_to    = 0.99662;
                    ...
                    env.threshold = -60. ;
                    break ;
                case 16 : /* Terfenadine - LOW */
                    console.log('Terfenadine - LOW') ;
                    env.C_Kr    = 0.74068;
                    env.C_CaL   = 0.97381;
                    env.C_Na    = 0.9917;
                    env.C_to    = 0.96445;
                    ...
                    env.threshold = -60. ;
                    break ;
                case 17 : /* Terfenadine - MID */
                    console.log('Terfenadine - MID') ;
                    env.C_Kr    = 0.41775;
                    env.C_CaL   = 0.88121;
                    env.C_Na    = 0.99174;
                    env.C_to    = 0.93149;
                    ...
                    env.threshold = -60. ;
                    break ;
                case 18 : /* Terfenadine - HIGH */
                    console.log('Terfenadine - HIGH') ;
                    env.C_Kr    = 0.29280;
                    env.C_CaL   = 0.79617;
                    env.C_Na    = 0.97961;
                    env.C_to    = 0.91173;
                    ...
                    env.threshold = -60. ;
                    break ;
                case 19 : /* verapamil - HIGH */
                    console.log('verapamil - LOW') ;
                    env.C_Kr    = 0.78050;
                    env.C_CaL   = 0.73187;
                    env.C_Na    = 0.997;
                    env.C_to    = 0.98351;
                    ...
                    env.threshold = -60. ;
                    break ;
                case 20 : /* verapamil - HIGH */
                    console.log('verapamil - MID') ;
                    env.C_Kr    = 0.26230;
                    env.C_CaL   = 0.17818;
                    env.C_Na    = 0.976;
                    env.C_to    = 0.90435;
                    ...
                    env.threshold = -60. ;
                    break ;
                case 21 : /* verapamil - HIGH */
                    console.log('verapamil - HIGH') ;
                    env.C_Kr    = 0.12451;
                    env.C_CaL   = 0.07333;
                    env.C_Na    = 0.94316;
                    env.C_to    = 0.81958;
                    ...
                    env.threshold = -60. ;
                    break ;
                case 22 : /* Dofetilide - LOW */
                    console.log('Dofetilide - LOW') ;
                    env.C_Kr    = 0.69136;
                    env.C_CaL   = 0.99711;
                    env.C_Na    = 0.9911;
                    env.C_to    = 0.85724;
                    ...
                    env.threshold = -60. ;
                    break ;
                case 23 : /* Dofetilide - MID */
                    console.log('Dofetilide - MID') ;
                    env.C_Kr    = 0.21997;
                    env.C_CaL   = 0.95603;
                    env.C_Na    = 0.93408;
                    env.C_to    = 0.48763;
                    ...
                    env.threshold = -60. ;
                    break ;
                case 24 : /* Dofetilide - HIGH */
                    console.log('Dofetilide - HIGH') ;
                    env.C_Kr    = 0.11002;
                    env.C_CaL   = 0.87866;
                    env.C_Na    = 0.86135;
                    env.C_to    = 0.31377;
                    ...
                    env.threshold = -60. ;
                    break ;
                case 25: /* quinidine - LOW */
                    console.log('quinidine - LOW') ;
                    env.C_Kr    = 0.27954;
                    env.C_Na    = 0.84040;
                    env.C_CaL   = 0.88142;
                    env.C_to    = 0.5242;
                    ...
                    env.threshold = -60. ;
                    break ;
                case 26: /* quinidine - MID */
                    console.log('quinidine - MID') ;
                    env.C_Kr    = 0.05796;
                    env.C_Na    = 0.56947;
                    env.C_CaL   = 0.19032;
                    env.C_to    = 0.05233;
                    ...
                    env.threshold = -60. ;
                    break ;
                case 27:  /* quinidine - HIGH */
                    console.log('quinidine - HIGH') ;
                    env.C_Kr    = 0.02871;
                    env.C_CaL   = 0.043288;
                    env.C_to    = 0.05613;
                    env.C_K1    = 0.01650;
                    ...
                    break ;
                case 28: /* HF */
                    console.log('Heart_failure - HIGH') ;
                    env.C_Na    = 0.43;
                    env.C_CaL   = 1.;
                    env.C_Kr    = 0.55;
                    env.C_to    = 0.27;
    ...
    // scriptRun function ................................................
    env.scriptRun = function(){
        if ( !env.scripting ) return ;
        if ( env.setNo < env.sets.length ){
            if (env.paceMakerNumber > 25  ){
                env.scriptSave() ;
                if (env.paceMakerPeriod > 1100 ){
                    env.paceMakerPeriod -= 200 ;
                }else if (env.paceMakerPeriod > 610){
                    env.paceMakerPeriod -= 100 ;
                }else if (env.paceMakerPeriod> 510){ 
                    env.paceMakerPeriod -= 50 ;
                }else{
                    env.paceMakerPeriod -= 25 ;
                }

                if (env.paceMakerPeriod < 290 ){
                    env.paceMakerPeriod = 450 ;
                    env.setNo++ ;
                }
                env.scriptInit() ;
            }
    ...
    // scriptSave: save the results ......................................
    env.scriptSave = function(){
        var file_prefix ;
        if (!env.paceMakerConstantDi){
            file_prefix = "BCL_"+env.sets[env.setNo]+"_"
                    +env.paceMakerPeriod  ;
        }else{
            file_prefix = "CDI_"+env.sets[env.setNo]+"_"
                    +env.paceMakerDi ;
        }

        env.ApdCvRecorder.save(file_prefix) ;    
        
        env.outputSetupFileName = file_prefix + "_setup.xml" ;
        env.saveSetupToXML() ;
        env.sampler.save( file_prefix + '_samples.tsv' ) ;

        env.canvasRecorder.filename = file_prefix + '.webm' ;
        //env.canvasRecorder.stop() ;
    }
...
env.ApdCvRecorder = new function(){
    ...
    this.save = function(fp){
        var file_prefix = 'run' ;
        var file_prefix = (fp) ? fp : 'run' ;
        var link =  document.createElement('a') ;
        var tsvEncoded = encodeURI(this.tsvHeader + this.tsvContent ) ;
        link.setAttribute('href', tsvEncoded ) ;
        link.setAttribute('download', file_prefix +'.tsv' ) ;
        link.click() ;
    }
}
 ...
 *-------------------------------------------------------------------------
 */
    // create a list of all number, boolean and string variables in env
    function createList(verbose){
    env.saveList = [] ;
        var keys = Object.keys(env) ;
        for(var i in keys){
            var key = env[keys[i]] ;
            if ( _.isNumber(key) || _.isBoolean(key) || _.isString(key) ){
                if(verbose){
                    console.log(keys[i],'=',key) ;
                }
                env.saveList.push(keys[i]) ;
            }
        }
    }
    createList(false) ;
    ...
    // output file name ..................................................
    env.outputSetupFileName = "setup.xml" ;
    env.saveSetupToXML = function(){
        var fn ;
    ...
    // input setup .......................................................
    env.inputSetup = document.createElement('input') ;
    env.inputSetup.setAttribute('type', 'file') ;
    env.loadSetupFromXML = function(){
        Abubu.loadFromXML({
    ...
    env.inputSetup.onchange = env.loadSetupFromXML ;

    // store default values ..............................................
    env.storage.storeAsXML({ xml : 'defaults',
            obj : env, names : env.saveList } ) ;

    // restore defaults ..................................................
    env.restoreDefaults = function(){
    ...
    // store setup .......................................................
    env.storeSetup = function(){
        env.storage.storeAsXML({ xml : 'setup',
            obj : env, names : env.saveList } ) ;
    }
    
    // restore setup .....................................................
    env.restoreSetup = function(){
        if( env.autoRestore ){
            var state = env.running ;
